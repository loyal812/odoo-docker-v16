...
class TestSP(TestAccountAccount):
    ...
    def test_invoice(self):
        ...
        invoice = self.move_model.with_context(default_move_type="out_invoice",check_move_validity=False).create(
            {
    ...
    def test_balanced_lines(self):
        ...
        invoice_form = Form(
            self.move_model.with_context(default_move_type="out_invoice", check_move_validity=False)
        )
